...
public class Ball : MonoBehaviour
{
    ...
    public void LaunchBall()
    {
        ...
        rigidBody2D.velocity = Vector2.up * speed;//No utilizamos el deltaTime por que, por que el motor de f�sica tiene tiempos delta definido y constantes que no dependen de la velocidad de la computadora 
    }
