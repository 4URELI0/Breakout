...
public class Paddle : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            //Obtenemos el componente PowerUp pero con el objeto de colisi�n por la informaci�n que este contiene con el paddle
            ...
            if (collision.GetComponent<PowerUp>().powerUpType == PowerUp.PowerUpType.IncreaseSize)
            {
                ...
                Debug.Log("Obtuvo un power up de:Aumento de tama�o" + gameManager.bigSize);//Verificacion
    ...
    IEnumerator BigSizePower()
    {
        ...
        //Incrementar de tama�o
        Vector3 newSize = transform.localScale;//Un vector3 que almacena el tama�o actual del paddle
        ...
        {
            newSize.x += Time.deltaTime;//Utilizamos un deltaTime para que su animaci�n sea fluida en el incremento
